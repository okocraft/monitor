...
export const getLinkWithGoogleMutationOptions = <
    TData = Awaited<ReturnType<typeof linkWithGoogle>>,
    TError = AxiosError<void>,
    TContext = unknown,
>(options?: {
...
>(options?: {
    ...
    >;
    axios?: AxiosRequestConfig;
}): UseMutationResult<TData, TError, { loginKey: string }, TContext> => {
...
>(options?: {
    ...
    >;
    axios?: AxiosRequestConfig;
}): UseMutationResult<TData, TError, { data: CurrentPage }, TContext> => {
