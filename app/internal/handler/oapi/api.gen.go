...
const (
	...
	SkipAuthScopes        skipAuthContextKey        = "SkipAuth.Scopes"
)
...
// Valid indicates whether the value is a known member of the SortableRoleDataType enum.
func (e SortableRoleDataType) Valid() bool {
	switch e {
	case SortableRoleDataTypeCreatedAt:
		return true
	case SortableRoleDataTypeName:
		return true
	case SortableRoleDataTypePriority:
		return true
	case SortableRoleDataTypeUpdatedAt:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SortableUserDataType enum.
func (e SortableUserDataType) Valid() bool {
	switch e {
	case SortableUserDataTypeCreatedAt:
		return true
	case SortableUserDataTypeLastAccess:
		return true
	case SortableUserDataTypeNickName:
		return true
	case SortableUserDataTypeRoleName:
		return true
	case SortableUserDataTypeRolePriority:
		return true
	case SortableUserDataTypeUpdatedAt:
		return true
	default:
		return false
	}
...
// skipAuthContextKey is the context key for SkipAuth security scheme
type skipAuthContextKey string
...
func (siw *ServerInterfaceWrapper) LinkWithGoogle(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "loginKey", chi.URLParam(r, "loginKey"), &loginKey, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetRoles(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "sorted_by", r.URL.Query(), &params.SortedBy, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
			siw.ErrorHandlerFunc(w, r, &RequiredParamError{ParamName: "sorted_by"})
		} else {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "sort_type", r.URL.Query(), &params.SortType, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
...
func (siw *ServerInterfaceWrapper) SearchUsers(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "nickname", r.URL.Query(), &params.Nickname, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "last_access_before", r.URL.Query(), &params.LastAccessBefore, runtime.BindQueryParameterOptions{Type: "string", Format: "date-time"})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
			siw.ErrorHandlerFunc(w, r, &RequiredParamError{ParamName: "last_access_before"})
		} else {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "last_access_after", r.URL.Query(), &params.LastAccessAfter, runtime.BindQueryParameterOptions{Type: "string", Format: "date-time"})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
			siw.ErrorHandlerFunc(w, r, &RequiredParamError{ParamName: "last_access_after"})
		} else {
	...
	err = runtime.BindQueryParameterWithOptions("form", false, false, "role_id", r.URL.Query(), &params.RoleId, runtime.BindQueryParameterOptions{Type: "string", Format: "uuid"})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
